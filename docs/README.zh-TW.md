...
Tavric's Blog 是一個以 Astro + Tailwind CSS 建置的靜態個人網站。文章內容由 Notion 管理，GitHub Actions 會同步 Notion 文章與圖片，建置後部署到 GitHub Pages。
...
- 部署：GitHub Actions 到 GitHub Pages
- Node 版本：24
